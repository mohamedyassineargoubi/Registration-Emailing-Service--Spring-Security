...
import com.amyz.registrationandemail.appuser.AppUserRole;
import com.amyz.registrationandemail.appuser.AppUserService;
import com.amyz.registrationandemail.email.EmailSender;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest request) {
		...
		emailSender.send(request.getEmail(), buildEmail(request.getLastName(), token) );
		return token;
	}
